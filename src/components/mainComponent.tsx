...
export default function MainComponent() {
  const connectWallet = async () => {
    window.alert("Connect wallet functionality is not implemented yet.");
  };
  return (
    <>
      <MainContainer>
        ...
        <main className="px-8 py-12">
          ...
          <p
              className="text-xl font-medium text-[#A3A3A3] mt-10 text-center">
              Ready to Mint? Connect your wallet to explore minting, repay
              loans, and view your rune stats.
            </p>
        </main>
      </MainContainer>
    </>
